...
<link rel="icon" href="resources/img/parking.png">
...
<link href="resources/css/theGarage.css" rel="stylesheet">
<!-- Custom styles for this application -->
...
<!-- The application template content will be injected here 
 ================================================== -->
		<div ui-view="mainbody" ng-controller="thegarageController"></div>
	...
	<script src="resources/js/lib/angular-sanitize.min.js"></script>
	<script src="resources/js/lib/select.min.js"></script>
	<script src="resources/js/mainController.js"></script>
	<script src="resources/js/configController.js"></script>
	<script src="resources/js/thegarageService.js"></script>
	<script src="resources/js/thegarageController.js"></script>
	<script src="resources/js/thegarage.js"></script>
